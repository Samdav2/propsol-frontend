...
import { Search, MessageCircle, Mail, Phone, Calendar, User, Loader2, Clock } from "lucide-react";
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                <div>
                    ...
                    <p className="text-slate-500">View and manage customer support tickets.</p>
                </div>
